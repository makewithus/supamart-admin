...
const base = 'inline-flex items-center justify-center gap-2 font-semibold text-sm rounded-md transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none';
